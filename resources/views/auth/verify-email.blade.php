<x-guest-layout>
    <div class="mb-4 text-sm text-gray-600 dark:text-gray-400">
        {{ __('Es necesario confimar la cuenta, revisa tu email y presiona en el enlace de confirmacion.') }}
    </div>

    @if (session('status') == 'verification-link-sent')
        <div class="mb-4 font-medium text-sm text-green-600 dark:text-green-400">
            {{ __('Hemos enviado un email de confirmacion al correo que registraste.') }}
        </div>
    @endif
